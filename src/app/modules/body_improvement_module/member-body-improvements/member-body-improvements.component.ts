...
@Component({
  selector: 'app-member-body-improvements',
  templateUrl: './member-body-improvements.component.html',
  styleUrls: ['./member-body-improvements.component.scss']
})
export class MemberBodyImprovementsComponent implements OnInit {
  ...
  constructor(private improvementReportService: MemberBodyImprovementsService, private toastr: ToastrService) { }

  ngOnInit() {

    this.memberId = sessionStorage.getItem("memberId");
    this.findSchedules(this.memberId);
  }
